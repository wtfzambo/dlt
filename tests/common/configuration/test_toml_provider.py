...
def test_write_value(toml_providers: ConfigProvidersContext) -> None:
    ...
    for provider in toml_providers.providers:
        ...
        assert provider.get_value(
            "deep_int", Any, "deep_pipeline", "deep", "deep", "deep", "deep"
        ...
        assert provider.get_value("deep_date", Any, None, "deep", "deep", "deep", "deep") == (
            now,
            "deep.deep.deep.deep.deep_date",
        )
        # in existing path
        provider.set_value("deep_list", [1, 2, 3], None, "deep", "deep", "deep")
        assert provider.get_value("deep_list", Any, None, "deep", "deep", "deep") == (
            [1, 2, 3],
        ...
        assert provider.get_value("deep_dict", Any, None, "dict_test") == (
            test_d1,
            "dict_test.deep_dict",
        )
        ...
        # get a fragment
        assert provider.get_value("inner_2", Any, None, "dict_test", "deep_dict", "embed") == (
            True,
