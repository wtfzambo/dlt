...
DUCK_DB_NAME = "%s.db"
DEFAULT_DUCK_DB_NAME = DUCK_DB_NAME % "sqlite"
LOCAL_STATE_KEY = "sqlite_database"


@configspec
class SqliteCredentials(ConnectionStringCredentials):
    drivername: Final[str] = "sqlite" # type: ignore
    ...
    #             self._conn = sqlite3.connect(database=self.database)
    ...
    def parse_native_representation(self, native_value: Any) -> None:
        try:
            ...
            import sqlite3
            if isinstance(native_value, sqlite3.Connection):
...
class SqliteClientConfiguration(DestinationClientDwhConfiguration):
    destination_name: Final[str] = "sqlite"  # type: ignore
